function [Signal_Segments] = Slicing_Function(EEG_Data,Slicing_Time_Sec)
% The Slicing Time input should be per minute;
Sample_Rate = EEG_Data.srate;
EEG_Signal = EEG_Data.data;
% Slicing_Time_Sec = Slicing_Time_Sec * 60 ; % Slicing Time per second
Slicing_Sample = Slicing_Time_Sec * Sample_Rate;
Rr = 1; 
Ll = Slicing_Sample;
Ind = 1 ;
Idx = 1;
